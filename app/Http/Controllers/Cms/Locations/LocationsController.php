...
namespace App\Http\Controllers\Cms\Locations;

use Illuminate\Http\Request;

use App\Models\Location as PageModel;
...
class LocationsController extends BaseController
{
    ...
    public function __construct(PageModel $model)
    {
        ...
        $this->pageUrl = 'locations';
        $this->pageName = 'Location';
        $this->pageItem = 'Location';
        $this->urlColumn = 'description_tr';
        $this->model = $model;
    ...
    public function create()
    {
        ...
        $marbles = Marble::pluck('title_tr','id')->all();
        return view('cms.'.$this->pageUrl.'.create',compact('marbles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $record->position=10;
        $record->save();
        $record->marbles()->sync($request->marble_list ?: []);
        SearchIndex::create([
    ...
    public function edit(PageModel $record)
    {
        ...
        checkPermissionFor('edit_content');
        $marbles = Marble::pluck('title_tr','id')->all();
        return view('cms.'.$this->pageUrl.'.edit', compact('record','marbles'));
    }
