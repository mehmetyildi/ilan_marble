...
namespace App\Http\Controllers\Cms\Marbles;

use Illuminate\Http\Request;

use App\Models\Marble as PageModel;
...
class MarblesController extends BaseController
{
    public function __construct(PageModel $model)
    {
        $this->middleware('auth');
        $this->pageUrl = 'marbles';
        $this->pageName = 'Marble';
