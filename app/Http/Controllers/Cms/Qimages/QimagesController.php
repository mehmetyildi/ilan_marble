...
namespace App\Http\Controllers\Cms\Qimages;

use Illuminate\Http\Request;

use App\Models\Qimage as PageModel;
...
class QimagesController extends BaseController
{
    public function __construct(PageModel $model)
    {
        $this->middleware('auth');
        $this->pageUrl = 'qimages';
        $this->pageName = 'Qimage';
