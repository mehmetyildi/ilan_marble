...
class Popup extends BaseModel
{
    ...
    public static $imageFields = array(
        ["name" => "image_path_tr", "width" => 700, "height" => 500, 'crop' => true, 'naming' => 'title_tr', 'diff' => 'tr'] ,//1.4
        ["name" => "image_path_en", "width" => 700, "height" => 500, 'crop' => true, 'naming' => 'title_tr', 'diff' => 'en'] //1.4
    );
