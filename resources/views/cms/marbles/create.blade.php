	...
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					@include('cms.includes.crop-image-area', ['title' => 'Slab Görsel (1200x750)', 'field' => 'image_path_slab', 'ratio' => '1.6', 'required' => false])
				</div>


				<div class="ibox-content">
					@include('cms.includes.crop-image-area', ['title' => 'Close Up Görsel (1200x750)', 'field' => 'image_path_close', 'ratio' => '1.6', 'required' => false])
				</div>
			</div>
			<div class="ibox float-e-margins">
				<div class="ibox-title">
