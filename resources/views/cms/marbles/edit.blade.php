	...
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					@include('cms.includes.crop-image-area', ['title' => 'Görsel (1200x750)', 'field' => 'image_path_slab', 'ratio' => '1.6', 'required' => false])
				</div>
				<div class="ibox-content">
					@include('cms.includes.crop-image-area', ['title' => 'Görsel (1200x750)', 'field' => 'image_path_close', 'ratio' => '1.6', 'required' => false])
				</div>
			</div>
			<div class="ibox float-e-margins">
				<div class="ibox-title">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					...
					<div class="form-group">
						<label class="control-label col-sm-3">
							Mevcut görsel <br><br>
							<button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteSlabImage"><i class="fa fa-trash"></i> Sil</button>
						</label>
						<div class="input-group col-sm-9">
							<img src="{{ url($record->image_path_slab) }}" class="img-responsive" alt="">
						</div>
					</div>
					@else
					Yüklenmiş bir görsel yok.
				...
				<div class="ibox-content">
					...
					<div class="form-group">
						<label class="control-label col-sm-3">
							Mevcut görsel <br><br>
							<button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteCloseImage"><i class="fa fa-trash"></i> Sil</button>
						</label>
						<div class="input-group col-sm-9">
							<img src="{{ url($record->image_path_close) }}" class="img-responsive" alt="">
						</div>
					</div>
					@else
					Yüklenmiş bir görsel yok.
...
<!-- Delete Object Modal -->
@include('cms.includes.delete-object-modal', [
'modal_id' => 'deleteSlabImage',
'field' => 'image_path_slab',
'route' => 'cms.'.$pageUrl.'.delete-file',
'id' => ['record' => $record->id]
])
<!-- End Delete Object Modal -->
<!-- Delete Object Modal -->
@include('cms.includes.delete-object-modal', [
'modal_id' => 'deleteCloseImage',
'field' => 'image_path_close',
'route' => 'cms.'.$pageUrl.'.delete-file',
'id' => ['record' => $record->id]
])
<!-- End Delete Object Modal -->
