...
<div class="wrapper wrapper-content animated fadeInRight">
   	<div class="row">
	   	{!! Form::model($record, ['route' => ['cms.'.$pageUrl.'.update', $record->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
			...
			<div class="col-lg-5">
				@include('cms.includes.form-partials.edit-publish-settings-with-publish_until')
				<div class="ibox float-e-margins">
					<div class="ibox-title">
					...
					<div class="ibox-content">
						@if($record->image_path_tr)
							<div class="form-group">
								...
								<div class="input-group col-sm-9">
									<img src="{{ url($record->image_path_tr) }}" class="img-responsive" alt="">
								</div>
							</div>
						@else
						...
						@if($record->image_path_en)
							<div class="form-group">
								...
								<div class="input-group col-sm-9">
									<img src="{{ url($record->image_path_en) }}" class="img-responsive" alt="">
								</div>
							</div>
						@else
