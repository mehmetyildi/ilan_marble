				...
				<div class="ibox-content">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<div class="tab-content">
								<div id="tab-description_tr" class="tab-pane active">
									{!! Form::textarea('address_tr', null, ['class' => 'form-control ckeditor', 'rows' => '3']) !!}
								</div>
								<div id="tab-description_en" class="tab-pane">
									{!! Form::textarea('address_en', null, ['class' => 'form-control ckeditor', 'rows' => '3']) !!}
								</div>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Enlem</label>
						<div class="col-sm-9">
							{!! Form::text('latitude', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Boylam</label>
						<div class="col-sm-9">
							{!! Form::text('longitude', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="form-group">
						<label for="title" class="col-sm-3 control-label">Etiketler</label>
						<div class="col-sm-9">
							{{ Form::select('marble_list[]', $marbles, $record->marbles, ['id' => 'marble_list', 'class' => 'form-control', 'multiple', 'style' => 'display: none; width: 100%;', 'tabindex' => '-1']) }}
						</div>
					</div>
...
<script>
	$(document).ready(function(){
		$("#marble_list").select2({placeholder: 'Çıkan Mermerleri Seçiniz'});
