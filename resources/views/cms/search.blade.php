                ...
                <div class="ibox-content">
                    ...
                    @if($results->count())
	                    ...
	                    <div class="search-result">
	                        <h3><a href="{{ url(config('app.cms_path').'/'.$result->folder.'/'.$result->key.'/edit') }}">{{ $result->keyword }} <small>({{$result->folder}})</small></a></h3>
	                        <a href="{{ url(config('app.cms_path').'/'.$result->folder.'/'.$result->key.'/edit') }}" class="search-link">{{ url(config('app.cms_path').'/'.$result->folder.'/'.$result->key.'/edit') }}</a>
