	...
	<div class="mainContainer">
		<nav class="navbar navbar-default">
			...
			<div class="navbar-header">
	     		 ...
	     		 <a class="navbar-brand" href="#"><a href="{{url($l.'/')}}" style="width: 150px; display: inline-block;"><img src="{{ url('/img/logo-new.png') }}" alt="" style="width: 150px;" class="centeredImage"></a></a>
    		</div>
