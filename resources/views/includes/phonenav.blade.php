			...
			<div class="collapse navbar-collapse" id="phoneCollapse">
				<ul class="nav navbar-nav">
					...
					<li class="{{ (strpos($currentRouteName, 'quarries') !== false) ? 'active' : '' }}">
						<a class="nav-link text-uppercase " href="{{ url($l.'/quarries') }}">{{ trans('layout.quarries') }}</a>
					</li>
					<li class="{{ (strpos($currentRouteName, 'projects') !== false) ? 'active' : '' }}">
						<a class="nav-link text-uppercase " href="{{ url($l.'/projects') }}">{{ trans('layout.projects') }}</a>
					</li>
					...
					<li class="{{ (strpos($currentRouteName, 'events') !== false) ? 'active' : '' }}">
						<a class="nav-link text-uppercase " href="{{ url($l.'/events') }}">{{ trans('layout.news') }}</a></li>
						<li class="{{ (strpos($currentRouteName, 'mags') !== false) ? 'active' : '' }}">
							<a class="nav-link text-uppercase " href="{{ url($l.'/mags') }}">E-MARBLE</a>
						</li>
						<li class="{{ (strpos($currentRouteName, 'contact') !== false) ? 'active' : '' }}">
							<a class="nav-link text-uppercase " href="{{ url($l.'/contact') }}">{{ trans('layout.contact') }}</a>
						</li>
